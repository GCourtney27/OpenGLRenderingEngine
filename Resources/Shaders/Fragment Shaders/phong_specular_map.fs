...
void main()
{
	...
	vec4 textureColor1 = texture(textureSample, fragment_uv);
	vec4 textureColor2 = texture(textureSample1, fragment_uv);
	vec4 textureColor = mix(textureColor1, textureColor2, textureColor1.a);
